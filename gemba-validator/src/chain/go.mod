module github.com/ivanovslavy/GembaBlockchain/chain
...
// Mirror the relevant cosmos/evm v0.7.0 replace directives so the SDK store
// stack resolves identically to the upstream node we wire into (CLAUDE.md §16.6).
replace (
