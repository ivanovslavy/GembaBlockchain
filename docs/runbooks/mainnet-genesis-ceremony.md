...
| Auto-unjail + auto-compound | `gemba-validator/auto/install-validator-auto.sh` on all 4 boxes; `validator-auto.env` with `CHAIN_ID=gemba-1` (keyring decision: I2 was risk-accepted 2026-07-17) | timers active (`systemctl list-timers`) |
